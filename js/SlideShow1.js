// get all the "City_Card"-Elements and put them in an Array, then handle each Element
Array.from(document.getElementsByClassName('City_Card')).forEach((card, index)=>{
